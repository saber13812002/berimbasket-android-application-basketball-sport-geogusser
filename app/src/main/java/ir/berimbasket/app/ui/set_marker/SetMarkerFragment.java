...
public class SetMarkerFragment extends Fragment implements OnMapReadyCallback {
...
//        }
        ...
        CameraPosition cameraPosition = ((SetMarkerActivity) getActivity()).getCameraPosition();
