...
public class ViewPagerRTL extends ViewPager {
    ...
    private void registerRtlDataSetObserver(PagerAdapter adapter) {
        if (adapter instanceof ReverseAdapterView && dataSetObserver == null) {
            dataSetObserver = new RevalidateIndicesOnContentChange((ReverseAdapterView) adapter);
            adapter.registerDataSetObserver(dataSetObserver);
            ((ReverseAdapterView) adapter).revalidateIndices();
        }
    }
    ...
    public PagerAdapter getAdapter() {
        final PagerAdapter adapter = super.getAdapter();
        return adapter instanceof ReverseAdapterView ? ((ReverseAdapterView) adapter).getInnerAdapter() : adapter;
    }
    ...
    public void setAdapter(@Nullable PagerAdapter adapter) {
        ...
        if (rtlReady) {
            adapter = new ReverseAdapterView(adapter);
    ...
    private class ReverseAdapterView extends ViewPagerAdapterWrapper {

        private int lastCount;

        public ReverseAdapterView(@NonNull PagerAdapter adapter) {
            super(adapter);
    ...
    private static class RevalidateIndicesOnContentChange extends DataSetObserver {
        @NonNull
        private final ReverseAdapterView adapter;

        private RevalidateIndicesOnContentChange(@NonNull ReverseAdapterView adapter) {
