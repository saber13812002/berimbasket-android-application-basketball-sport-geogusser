...
import ir.berimbasket.app.bundle.BundleMatchScore;

public class AdapterMatchBoard extends RecyclerView.Adapter<AdapterMatchBoard.MatchViewHolder> {

    ArrayList<BundleMatchScore> matchScores;
    Typeface typeface;
    private Context context;
    private LayoutInflater inflater;

    // Provide a suitable constructor (depends on the kind of dataset)
    public AdapterMatchBoard(Context context) {
